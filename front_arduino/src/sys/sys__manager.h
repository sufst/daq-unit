...
#define SYS__MANAGER__ACCELEROMETER_X_PIN 1
#define SYS__MANAGER__ACCELEROMETER_Y_PIN 2
#define SYS__MANAGER__ACCELEROMETER_Z_PIN 3

#define SYS__MANAGER__RIDE_HEIGHT_ENABLED 1
#define SYS__MANAGER__RIDE_HEIGHT_PIN 4

#define SYS__MANAGER__WHEEL_SPEED_ENABLED 1
#define SYS__MANAGER__WHEEL_SPEED_PIN 5
