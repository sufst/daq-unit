...
* @brief device layer for analgog read of ride height
...
----------------------------------------------------------------------------*/
/*************************************************************************//**
* @brief Read the ride height pin voltage in micro volts
* @param dev__ride__height__obj_t *obj Ride height device object
* @return uint32_t 
* @note
*****************************************************************************/
inline uint32_t dev__ride_height__read_uv(dev__ride__height__obj_t *obj)
{
