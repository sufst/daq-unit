...
/*#if SYS__MANAGER__ACCELEROMETERS_ENABLED
    ...
    uint8_t dampersPins[SYS__MANAGER__DAMPER_POTS_ATTACHED_AMT] = {SYS__MANAGER__DAMPER_POT_L_PIN,
                                                                   SYS__MANAGER__DAMPER_POT_R_PIN};
    ...
    uint8_t wheelSpeedPins[SYS__MANAGER__WHEEL_SPEEDS_ATTACHED_AMT] = {SYS__MANAGER__WHEEL_SPEED_L_PIN,
                                                                       SYS__MANAGER__WHEEL_SPEED_R_PIN};
